...
import { AGING_BUCKETS, BUCKET_COLOR, BUCKET_LABEL, fmt, fmtDate } from '@/features/reports/constants';
  ...
  return (
    <div className="space-y-4">
      ...
      <ReportShell
        ...
        tableHeaders={['Customer','Invoice #','Issue Date','Due Date','Days Overdue','Amount','Currency','Bucket']}
        tableRows={tableRows}
        chartContent={
