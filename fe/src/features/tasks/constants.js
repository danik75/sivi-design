export const TASK_TEXT = {
  ...
  modal: {
    ...
    actualHoursPlaceholder: '0.0',
    actualHoursRequired: 'Actual hours are required to mark a task done.',
  ...
  complete: {
    title: 'Complete task',
    body: (name) => `How many hours did "${name}" take?`,
    actualHoursLabel: 'Actual hours',
    estimateHint: (h) => `Estimated: ${h}h`,
    noEstimate: 'No estimate was set.',
    required: 'Actual hours are required to mark a task done.',
    cancel: 'Cancel',
    confirm: 'Mark done',
    error: 'Unable to complete task.',
    success: (name) => `"${name}" marked done.`,
  },
  views: {
    gantt: 'Gantt',
    grid: 'Grid',
