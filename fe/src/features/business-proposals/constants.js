...
export const BUSINESS_PROPOSALS_TEXT = {
  ...
  modal: {
    ...
    intro: 'I will ask a few questions and prepare the proposal request.',
    customerQuestion: 'For which customer is this proposal?',
    requirementQuestion: 'What is the business requirement?',
    requirementPlaceholder: 'Describe goals, scope, constraints, and expected outcomes...',
    pricingQuestion: 'Which pricing model should be used?',
    estimatedHoursQuestion: 'How many hours are expected?',
    estimatedHoursPlaceholder: '220',
    hourlyRateQuestion: 'What hourly rate should be charged?',
    hourlyRatePlaceholder: '350',
    currencyQuestion: 'Which currency should be used?',
    paymentQuestion: 'How should payments be distributed?',
    paymentPlaceholder: '30% upfront, 40% on milestone, 30% on delivery',
    languageQuestion: 'Which language was requested by the user?',
    cancel: 'Cancel',
    send: 'Send',
